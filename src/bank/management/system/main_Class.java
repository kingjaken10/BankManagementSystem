...
public class main_Class extends JFrame implements ActionListener{
    ...
    main_Class(String pin){
        ...
        transactionLabel.setBounds(415, 190, 700, 35);   // set bounds
        ...
        depositButton.setBounds(415, 284, 150, 34);    // set bounds
        ...
        fastCashButton.setBounds(415, 333, 150, 34);    // set bounds
        ...
        pinChangeButton.setBounds(415, 382, 150, 34);    // set bounds
        ...
        withdrawalButton.setBounds(690, 284, 150, 34);    // set bounds
        ...
        miniStmtButton.setBounds(690, 333, 150, 34);    // set bounds
        ...
        balanceButton.setBounds(690, 382, 150, 34);    // set bounds
        ...
        exitButton.setBounds(690, 430, 150, 34);    // set bounds
