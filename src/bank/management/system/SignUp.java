...
public class SignUp extends JFrame implements ActionListener{
    ...
    JTextField firstNameText, lastNameText, phoneText, emailText, addressText, cityText, stateText, zipText;   // text fields
    ...
    public void actionPerformed(ActionEvent e){
        ...
        String phone = phoneText.getText(); // get phone number
        ...
        try{
            ...
            if(!firstName.equals("") && !lastName.equals("") && !dob.equals("" ) && !gender.equals("") 
               && !email.equals("") && !maritalStatus.equals("") && !address.equals("") && !phone.equals("")
               && !city.equals("") && !state.equals("") && !zipCode.equals("")){
